...
const DetailedComparisonForm = ({ onSubmit }: DetailedComparisonFormProps) => {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
            Comparatore luce e gas Selectra: confronta le tariffe
          </h2>
          ...
          <CardContent className="p-8">
            <form onSubmit={handleFormSubmit} className="space-y-8">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <Button
                    ...
                    className="p-6 h-auto text-base"
                  >
                  ...
                  <Button
                    ...
                    className="p-6 h-auto bg-gaspower-blue hover:bg-blue-600 text-base"
                  >
                    <Zap className="h-5 w-5 mr-2" />
                    Elettricità e gas
                  </Button>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <Button
                      type="button"
                      variant={currentKnowledge === 'yes' ? 'default' : 'outline'}
                      onClick={() => setCurrentKnowledge('yes')}
                      className="p-4"
                    >
                      Sì
                    </Button>
                    <Button
                      type="button"
                      variant={currentKnowledge === 'no' ? 'default' : 'outline'}
                      onClick={() => setCurrentKnowledge('no')}
                      className="p-4"
                    >
                      No
                    </Button>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <Button
                      type="button"
                      variant={isResident === 'yes' ? 'default' : 'outline'}
                    ...
                    <Button
                      type="button"
                      variant={isResident === 'no' ? 'default' : 'outline'}
              ...
              <div className="bg-gradient-to-r from-blue-50 to-green-50 p-6 rounded-lg">
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <input 
                        ...
                        className="w-full h-2 bg-gaspower-green rounded-lg appearance-none cursor-pointer"
                      />
                ...
                {/* Appliances */}
                <ApplianceSelector
                  title="* I tuoi elettrodomestici"
                  appliances={appliances}
                  selectedAppliances={selectedAppliances}
                  onSelectionChange={setSelectedAppliances}
                />
              </div>
              ...
              <div className="bg-gradient-to-r from-gaspower-blue to-blue-600 p-8 rounded-lg text-center">
                ...
                <Button
                  type="submit"
                  className="bg-white text-gaspower-blue hover:bg-gray-100 font-bold text-lg px-12 py-4 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-200"
                >
